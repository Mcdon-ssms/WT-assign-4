...
<head>
    ...
    <title>Examples For Data Class</title>
</head>
<body>
       ...
       // let base_url = "http://edutechclsx.000webhostapp.com/api/test/";
        ...
        function getItemNameList()
        {
            ...
            $.get(url,function(data,success)
            {
				...
				//the document.getElementById("demo").innerHTML = data.id + "," + data.short_name + "," + data.name + "," + data.description + "," + data.price_small + "," + data.price_large + ","+ data.small_portion_name + "," + data.large_portion_name;
            }
          );
        }
	...
	<p id="demo1"></p>
	<label for="no">Enter The Item ID</label><br>
